                    ...
                    <ul class="navbar-nav">
                        <li clas="nav-item">
                            <div class="navbar-brand-container">
                                ...
                                if(!isset($_SESSION['business_owner'])) {
                                    echo '<li class="nav-item">
                                    <a class="nav-link" href="#">Welcome Guest</a>
                                </li>';
                                } else {
                                    echo "<li class='nav-item'>
                                    <a class='nav-link' href='#'>Welcome, ".$_SESSION['business_owner']."!</a>
                                </li>";
                                }
        ...
        <div class="row">
            <div class="col-md-12 p-1 align-items-center">
                ...
                <?php
                    ...
                    if(!isset($_SESSION['business_owner'])) {
                         echo "<p class='text-dark text-center'>Business Name</p>";
                    } else {
                        echo "<p class='text-dark text-center'>".$_SESSION['business_name']."</p>";
                    }
